...
export enum ProductActionTypes {
  ...
  ClearCurrentProductId = '[Product] Clear Current Product',
...
export class ClearCurrentProductId implements Action {
  readonly type = ProductActionTypes.ClearCurrentProductId;
}
